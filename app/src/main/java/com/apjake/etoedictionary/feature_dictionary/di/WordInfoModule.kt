package com.apjake.etoedictionary.feature_dictionary.di

import android.app.Application
import androidx.room.Room
import com.apjake.etoedictionary.feature_dictionary.data.local.Converters
import com.apjake.etoedictionary.feature_dictionary.data.local.WordInfoDao
import com.apjake.etoedictionary.feature_dictionary.data.local.WordInfoDatabase
import com.apjake.etoedictionary.feature_dictionary.data.remote.DictionaryApi
import com.apjake.etoedictionary.feature_dictionary.data.repository.WordInfoRepositoryImpl
import com.apjake.etoedictionary.feature_dictionary.data.util.GsonParser
